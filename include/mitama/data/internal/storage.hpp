...
public:
  ...
  constexpr named_storage(const named_storage&) = default;
  constexpr named_storage(named_storage&&) = default;
  constexpr named_storage& operator=(const named_storage&) = default;
  ...
  template <class U, class... Args>
    requires std::constructible_from<T, Args...>
  constexpr explicit named_storage(
  ...
  constexpr decltype(auto) indirect() &
  {
    return std::addressof(value);
  }
  constexpr decltype(auto) indirect() const&
  {
    return std::addressof(value);
  }
};
